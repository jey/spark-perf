...
GROUPBY_NUM_TUPLES = [1000000, 10000000, 100000000]
# Number of distinct keys
GROUPBY_DISTINCT_KEYS = [100, 10000]
...
# Toal number of KV-Pairs
SORTBY_NUM_TUPLES = [1000000, 10000000, 100000000]
# Number of distinct keys
SORTBY_DISTINCT_KEYS = [100, 10000]
...
KMEANS_NUM_POINTS = [100000, 1000000, 10000000, 50000000]
